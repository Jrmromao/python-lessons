...
input_var = float(input('Insert a valor: '))

print(f'{input_var}')
print(f'{type(input_var)}')

input_var = int(input_var)


# the input function will convert whatever you type into a string datatype
